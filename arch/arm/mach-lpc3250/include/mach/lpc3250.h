 ...
 */
struct uart_regs {
	unsigned int dll_fifo;     /* UART data FIFO/holding/dll reg */
	unsigned int dlm_ier;      /* UART high divisor/int enable reg */
	unsigned int iir_fcr;      /* UART int pending/FIFO contrl reg */
	unsigned int lcr;          /* UART line control reg */
	unsigned int modem_ctrl;   /* UART modem control reg */
	unsigned int lsr;          /* UART line status reg */
	unsigned int modem_status; /* UART modem status reg */
	unsigned int rxlev;        /* UART RX FIFO level reg */
};
...
#define UARTCNTL ((struct uart_ctrl_regs *) (UART_CTRL_BASE))
...
struct timer_cntr_regs {
	unsigned int ir;          /* Timer interrupt status reg */
	unsigned int tcr;         /* Timer control register */
	unsigned int tc;          /* Timer counter value reg */
	unsigned int pr;          /* Timer prescale register */
	unsigned int pc;          /* Timer prescale counter reg */
	unsigned int mcr;         /* Timer Match control reg */
	unsigned int mr[4];       /* Timer Match registers */
	unsigned int ccr;         /* Timer Capture control reg */
	unsigned int cr[4];       /* Timer Capture registers */
	unsigned int emr;         /* Timer External match reg */
	unsigned int rsvd2[12];   /* Reserved */
	unsigned int ctcr;        /* Timer Count control reg */
};
...
#define TIMER_CNTR0 ((struct timer_cntr_regs *)(TIMER0_BASE))
#define TIMER_CNTR1 ((struct timer_cntr_regs *)(TIMER1_BASE))
#define TIMER_CNTR2 ((struct timer_cntr_regs *)(TIMER2_BASE))
#define TIMER_CNTR3 ((struct timer_cntr_regs *)(TIMER3_BASE))

/* WDT module register structures */
struct wdt_regs {
	unsigned int wdtim_int;      /* WDT interrupt status register */
	unsigned int wdtim_ctrl;     /* WDT control register */
	unsigned int wdtim_counter;  /* WDT counter value register */
	unsigned int wdtim_mctrl;    /* WDT match control register */
	unsigned int wdtim_match0;   /* WDT match 0 register */
	unsigned int wdtim_emr;      /* WDT external match control reg */
	unsigned int wdtim_pulse;    /* WDT reset pulse length register */
	unsigned int wdtim_res;      /* WDT reset source register */
};
...
#define WDT ((struct wdt_regs *)(WDTIM_BASE))
...
#define SLCNAND ((struct slcnand_regs *)(SLC_BASE))
...
struct lpc3250_ethernet_regs {
	...
	unsigned long sa [3];
	unsigned long reserved2 [45];
	/* Control registers */
	unsigned long command;
	unsigned long status;
	unsigned long rxdescriptor;
	unsigned long rxstatus;
	unsigned long rxdescriptornumber;
	unsigned long rxproduceindex;
	unsigned long rxconsumeindex;
	unsigned long txdescriptor;
	unsigned long txstatus;
	unsigned long txdescriptornumber;
	unsigned long txproduceindex;
	unsigned long txconsumeindex;
	unsigned long reserved3 [10];
	unsigned long tsv0;
	unsigned long tsv1;
	unsigned long rsv;
	unsigned long reserved4 [3];
	unsigned long flowcontrolcounter;
	unsigned long flowcontrolstatus;
	unsigned long reserved5 [34];
	/* RX filter registers */
	unsigned long rxfliterctrl;
	unsigned long rxfilterwolstatus;
	unsigned long rxfilterwolclear;
	unsigned long reserved6;
	unsigned long hashfilterL;
	unsigned long hashfilterh;
	unsigned long reserved7 [882];
...
/* SSP Module Register Structure */
struct lpc3250_ssp_regs {
	unsigned long cr0;     /* SSP control register 0 */
	unsigned long cr1;     /* SSP control register 1 */
	unsigned long data;    /* SSP data register */
	unsigned long sr;      /* SSP status register */
	unsigned long cpsr;    /* SSP clock prescale register */
	unsigned long imsc;    /* SSP interrupt mask register */
	unsigned long ris;     /* SSP raw interrupt status register */
	unsigned long mis;     /* SSP masked interrupt status register */
	unsigned long icr;     /* SSP interrupt clear register */
	unsigned long dmacr;   /* SSP DMA enable register */
};
...
/* GPIO Module Register Structure */
struct lpc3250_gpio_regs {
	unsigned long p3_inp_state;   /* Input pin state register */
	unsigned long p3_outp_set;    /* Output pin set register */
	unsigned long p3_outp_clr;    /* Output pin clear register */
	unsigned long p3_outp_state;  /* Output pin state register */
	unsigned long p2_dir_set;     /* GPIO direction set register */
	unsigned long p2_dir_clr;     /* GPIO direction clear register */
	unsigned long p2_dir_state;   /* GPIO direction state register */
	unsigned long p2_inp_state; /* SDRAM-Input pin state register*/
	unsigned long p2_outp_set;  /* SDRAM-Output pin set register */
	unsigned long p2_outp_clr;  /* SDRAM-Output pin clear register*/
	unsigned long p2_mux_set;     /* PIO mux control set register*/
	unsigned long p2_mux_clr;     /* PIO mux control clear register*/
	unsigned long p2_mux_state;   /* PIO mux state register */
	unsigned long reserved1 [3];
	unsigned long p0_inp_state;    /* P0 GPIOs pin read register */
	unsigned long p0_outp_set;    /* P0 GPIOs output set register */
	unsigned long p0_outp_clr;    /* P0 GPIOs output clear register */
	unsigned long p0_outp_state;  /* P0 GPIOs output state register */
	unsigned long p0_dir_set;     /* P0 GPIOs direction set reg */
	unsigned long p0_dir_clr;     /* P0 GPIOs direction clear reg */
	unsigned long p0_dir_state;   /* P0 GPIOs direction state reg */
	unsigned long reserved2;
	unsigned long p1_inp_state;    /* P1 GPIOs pin read register */
	unsigned long p1_outp_set;    /* P1 GPIOs output set register */
	unsigned long p1_outp_clr;    /* P1 GPIOs output clear register */
	unsigned long p1_outp_state;  /* P1 GPIOs output state register */
	unsigned long p1_dir_set;     /* P1 GPIOs direction set reg */
	unsigned long p1_dir_clr;     /* P1 GPIOs direction clear reg */
	unsigned long p1_dir_state;   /* P1 GPIOs direction state reg */
	unsigned long reserved3;
	unsigned long reserved4 [32];
	unsigned long p_mux_set;     /* PIO mux2 control set register*/
	unsigned long p_mux_clr;     /* PIO mux2 control clear register*/
	unsigned long p_mux_state;   /* PIO mux2 state register */
	unsigned long reserved5;
	unsigned long p3_mux_set;     /* PIO mux3 control set register*/
	unsigned long p3_mux_clr;     /* PIO mux3 control clear register*/
	unsigned long p3_mux_state;   /* PIO mux3 state register */
	unsigned long reserved6;
	unsigned long p0_mux_set;       /* P0 mux control set register*/
	unsigned long p0_mux_clr;       /* P0 mux control clear register*/
	unsigned long p0_mux_state;     /* P0 mux state register */
	unsigned long reserved7;
	unsigned long p1_mux_set;       /* P1 mux control set register*/
	unsigned long p1_mux_clr;       /* P1 mux control clear register*/
	unsigned long p1_mux_state;     /* P1 mux state register */
};
...
#define GPIO  ((struct lpc3250_gpio_regs *)(GPIO_BASE))
...
struct hsuart_control {
	unsigned int baud_rate;
	unsigned int cts_en;
	unsigned int cts_inv;
	unsigned int rts_en;
	unsigned int rts_inv;
};

struct hsuart_regs {
	unsigned int txrx_fifo;
	unsigned int level;
	unsigned int iir;
	unsigned int ctrl;
	unsigned int rate;
...
struct otgi2c_regs {
	unsigned long otg_i2c_txrx;      /* OTG I2C Tx/Rx Data FIFO */
	unsigned long otg_i2c_stat;      /* OTG I2C Status Register */
	unsigned long otg_i2c_ctrl;      /* OTG I2C Control Register */
	unsigned long otg_i2c_clk_hi;    /* OTG I2C Clock Divider high */
	unsigned long otg_i2c_clk_lo;    /* OTG I2C Clock Divider low */
};
...
struct otg_regs {
	unsigned long reserved1[64];
	unsigned long otg_int_sts;      /* OTG int status register */
	unsigned long otg_int_enab;     /* OTG int enable register */
	unsigned long otg_int_set;      /* OTG int set register */
	unsigned long otg_int_clr;      /* OTG int clear register */
	unsigned long otg_sts_ctrl;     /* OTG status/control register */
	unsigned long otg_timer;        /* OTG timer register */
	unsigned long reserved2[122];
	struct otgi2c_regs otg_i2c;
	unsigned long reserved3[824];
	unsigned long otg_clk_ctrl;      /* OTG clock control reg */
	unsigned long otg_clk_sts;       /* OTG clock status reg */
};
