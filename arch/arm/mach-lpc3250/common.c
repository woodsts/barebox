 ...
 */
static unsigned int
clkpwr_check_pll_setup(unsigned int ifreq, CLKPWR_HCLK_PLL_SETUP_T * pllsetup)
{
	...
	mode = (pllsetup->cco_bypass_b15 << 2) |
	    (pllsetup->direct_output_b14 << 1) | pllsetup->fdbk_div_ctrl_b13;
 ...
 */
static unsigned int
clkpwr_pll_rate_from_val(unsigned int osc_rate, unsigned int val)
{
 ...
 */
static unsigned int
clkpwr_pll_rate(unsigned int osc_rate, unsigned int *pPllreg)
{
